...
class DESOM:
    ...
    def initialize(self, ae_act='relu', ae_init='glorot_uniform'):
        ...
        self.model = Model(inputs=[self.encoder.input, self.mlp_model.input], outputs=som_layer)
...
if __name__ == "__main__":
    ...
    #     desom.pretrain(X=X_train, y=None, optimizer=pretrain_optimizer,
    ...
    if args.dataset in ['mnist', 'fmnist', 'usps']:
        img_size = int(np.sqrt(x_img.shape[1]))
